...
export default function Home() {
  ...
  // Al acertar la foto, primero un pequeño brillo dorado sobre esa copia
  // concreta (para que se note "sí, es él") y solo después el modal -- que
  // saliera el modal de golpe, sin ningún aviso previo, se sentía demasiado
  // brusco.
