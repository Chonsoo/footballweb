...
export interface QuestionConfig {
  ...
  player_nationality?: string // 'choice' con player_choice — limita el buscador a una nacionalidad, código ISO-2 (p.ej. "ES" para el Trofeo Zarra, solo jugadores españoles)
